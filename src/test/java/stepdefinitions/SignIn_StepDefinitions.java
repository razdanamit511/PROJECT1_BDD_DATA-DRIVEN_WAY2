...
public class SignIn_StepDefinitions {
	...
	public void user_enters_data_from_and_in_sign_in_form(String string, String string2, String string3) throws Exception {
		...
		List<Map<String, String>> allData = XLUtils.getAllSheetData("E:\\LEARNING\\SOFTWARE TESTING\\02- TRAINING\\04- AUTOMATED TESTING\\04- HOW TO PERFORM\\02- CODE BASED AUTOMATION\\02 - AUTOMATION TYPES\\1- WEB AUTOMATION\\02 - FRAMEWORKS\\2- CUICUMBER Framework\\2- Tutoriuals\\12- HYBRID FRAMEWORK DESIGN\\TestData.xlsx", string2);
